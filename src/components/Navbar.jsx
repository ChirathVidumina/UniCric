...
export const Navbar = () => {
  return (
    <>
      {/* Top Header (Always at top, contains full nav on PC, only brand & status on Mobile) */}
      <header className="navbar-header">
        <div className="navbar-inner">
          ...
          {/* Desktop Navigation Links (PC View Only) */}
          <nav className="navbar-links desktop-nav-links">
            <NavLink 
              to="/" 
      ...
      {/* Mobile Footer Navigation Bar (Mobile Responsive View Only) */}
      <nav className="mobile-bottom-dock">
        ...
        <NavLink 
          ...
          className={({ isActive }) => (isActive ? 'mobile-nav-item active' : 'mobile-nav-item')}
        >
          <Target className="mobile-nav-icon" size={20} />
          <span className="mobile-nav-label">Scouting</span>
        </NavLink>
        ...
        <NavLink 
          ...
          className={({ isActive }) => (isActive ? 'mobile-nav-item active' : 'mobile-nav-item')}
        >
          <Trophy className="mobile-nav-icon" size={20} />
          <span className="mobile-nav-label">Championship</span>
        </NavLink>
